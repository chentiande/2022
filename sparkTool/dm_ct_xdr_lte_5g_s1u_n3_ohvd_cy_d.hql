...
drop table if exists dm_ct_xdr_lte_5g_s1u_n3_ohvd_cy_d;
create EXTERNAL table IF NOT EXISTS dm_ct_xdr_lte_5g_s1u_n3_ohvd_cy_d(
`starttime` timestamp,
`ue_ambr_ul` bigint,
`ue_ambr_dl` bigint,
`apn_ambr_ul` bigint,
...
location "${hivevar:basepath}/dm_ct_xdr_lte_5g_s1u_n3_ohvd_cy_d/";