...
drop table if exists dm_ct_xdr_lte_5g_s1u_n3_ohvd_prov_d;
create EXTERNAL table IF NOT EXISTS dm_ct_xdr_lte_5g_s1u_n3_ohvd_prov_d(
`starttime` timestamp,
`province_id` int,
...
`service_perceive_bad_imsi_cnt` bigint,
`service_perceive_bad_imsi_rate` decimal(12,6),
...
location "${hivevar:basepath}/dm_ct_xdr_lte_5g_s1u_n3_ohvd_prov_d/";