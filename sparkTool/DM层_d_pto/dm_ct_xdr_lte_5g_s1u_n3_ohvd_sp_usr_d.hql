...
drop table if exists dm_ct_xdr_lte_5g_s1u_n3_ohvd_sp_usr_d;
create EXTERNAL table IF NOT EXISTS dm_ct_xdr_lte_5g_s1u_n3_ohvd_sp_usr_d(
`starttime` timestamp,
...
location "${hivevar:basepath}/dm_ct_xdr_lte_5g_s1u_n3_ohvd_sp_usr_d/";