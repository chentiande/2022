...
drop table if exists dm_ct_xdr_lte_5g_s1u_n3_ohvd_cell_d;
create EXTERNAL table IF NOT EXISTS dm_ct_xdr_lte_5g_s1u_n3_ohvd_cell_d(
`starttime` timestamp,
`province_id` int,
...
`is_bad_quality_cell` int,
`azimuthal_angle` decimal(12,6),
...
location "${hivevar:basepath}/dm_ct_xdr_lte_5g_s1u_n3_ohvd_cell_d/";