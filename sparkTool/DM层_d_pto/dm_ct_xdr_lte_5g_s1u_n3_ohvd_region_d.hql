...
drop table if exists dm_ct_xdr_lte_5g_s1u_n3_ohvd_region_d;
create EXTERNAL table IF NOT EXISTS dm_ct_xdr_lte_5g_s1u_n3_ohvd_region_d(
`starttime` timestamp,
`province_id` int,
...
location "${hivevar:basepath}/dm_ct_xdr_lte_5g_s1u_n3_ohvd_region_d/";