...
drop table if exists dm_ct_xdr_ohvd_usrcell_d;
create EXTERNAL table IF NOT EXISTS dm_ct_xdr_ohvd_usrcell_d(
`starttime` timestamp,
`imsi_supi` varchar(16),
`msisdn` varchar(16),
`nci_eci` bigint,
`nc_ec_id` bigint,
...
location "${hivevar:basepath}/dm_ct_xdr_ohvd_usrcell_d/";