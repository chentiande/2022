...
drop table if exists dm_ct_xdr_lte_5g_s1u_n3_ohvd_sp_cy_d;
create EXTERNAL table IF NOT EXISTS dm_ct_xdr_lte_5g_s1u_n3_ohvd_sp_cy_d(
`starttime` timestamp,
`app_id` int,
...
location "${hivevar:basepath}/dm_ct_xdr_lte_5g_s1u_n3_ohvd_sp_cy_d/";